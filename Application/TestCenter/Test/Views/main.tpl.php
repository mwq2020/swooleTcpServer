<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<ul class="nav nav-tabs">
				<li>
					<a href="http://<?php echo strchr($_SERVER['HTTP_HOST'],':',true); ?>:55757">概述</a>
				</li>
				<li>
					<a href="http://<?php echo strchr($_SERVER['HTTP_HOST'],':',true); ?>:55757/?fn=statistic">监控</a>
				</li>
				<li>
					<a href="http://<?php echo strchr($_SERVER['HTTP_HOST'],':',true); ?>:55757/?fn=logger">日志</a>
				</li>
				<li class="disabled">
					<a href="">告警</a>
				</li>
	...
	<div class="row clearfix">
		...
		<div class="col-md-12 column" id="service_content" style="margin-top:10px;">
			<?php if(isset($service_data)){ echo '<h3>返回结果</h3><pre>'; print_r($service_data); echo '</pre><br>程序执行耗时：'. $cost .' seconds'; }  ?>
