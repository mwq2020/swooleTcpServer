...
class Pagination
{
    ...
    {
        //$this->p = isset($_GET['p']) ? $_GET['p'] : 1; //设置分页参数名称
        /* 基础设置 */
    ...
    public function show()
    {
        ...
        $this->url                 = '/logger/index?'.http_build_query($this->parameter);
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<nav><ul class='pagination pagination-sm'>{$page_str}</ul></nav>";
    }
